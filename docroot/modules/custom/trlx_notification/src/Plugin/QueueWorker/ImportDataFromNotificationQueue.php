    ...
    try {
      $params = [
        ...
        'body' => [
          ...
          'notificationIcon' => $indexValues['notificationIcon'],
          'notificationDate' => $indexValues['notificationDate'],
          'notificationClassroomLevelId' => $indexValues['notificationClassroomLevelId'],
          'notificationLink' => $indexValues['notificationLink'],
          'notificationLinkType' => $indexValues['notificationLinkType'],
          'notificationClassroomContentId' => $indexValues['notificationClassroomContentId'],
          'notificationBrandId' => $indexValues['notificationBrandId'],
          'notificationFlag' => '0',
